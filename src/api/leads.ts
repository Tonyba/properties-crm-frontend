...
import type { AddSelectsResponse, Agent, CreateLeadRequest, GetLeadsResponse, Lead, ListLeadRequest, SingleLeadResponse } from "../helpers/types";
...
export const leads_list = (request: ListLeadRequest) => {
    ...
    return axios.post<GetLeadsResponse>(

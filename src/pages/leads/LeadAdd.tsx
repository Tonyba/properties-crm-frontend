...
export default function LeadAdd() {
    ...
    const { data: lead } = useSuspenseQuery(useSingleLead(params.leadId ?? '', true));
    ...
    return (
        <ModuleContentWrapper>
                            ...
                            type == 'select' && (
                                key == 'requested_property' ?
                                    ...
                                    : <Select
                                        ...
                                        options={selectData[key as keyof AddSelectsResponse] ? formatData(key, options) : options}
                                        value={leadData?.[key as keyof Lead]
                                            ? {
            ...
            <SaveBottomBar isLoading={status == 'pending'} onSubmit={handleSave} onCancel={handleCancel} />
        </ModuleContentWrapper>
    )
}
